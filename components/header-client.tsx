                  ...
                  <SheetContent side="right" className="bg-white border-l border-border/20 shadow-2xl w-80 p-0">
                    ...
                    <div className="flex flex-col h-full">
                      ...
                      <nav className="flex-1 px-4 py-6 space-y-2">
                        {navItems.map((item) => (
                          <Link key={item.href} href={item.href} className="block p-4 rounded-xl transition-all duration-200 hover:bg-gray-50 active:scale-95 group">
                            <span className="nts-text-caps text-base font-bold text-foreground group-hover:text-gray-700">{item.label.toUpperCase()}</span>
                          </Link>
                        ))}
                        ...
                        >
                          <span className="nts-text-caps text-base font-bold text-foreground group-hover:text-gray-700">QUICK SEARCH</span>
                        </button>
                      </nav>
